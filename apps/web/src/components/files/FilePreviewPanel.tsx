...
import { isWorkspaceImagePreviewPath } from "@platon/shared/filePreview";
...
const FILE_EXPLORER_STORAGE_KEY = "platon-code.fileExplorerOpen";
const RENDER_MARKDOWN_STORAGE_KEY = "platon-code.renderMarkdown";
