  ...
  const checkpoints: VcsDriver.VcsCheckpointOps = {
    captureCheckpoint: Effect.fn("GitVcsDriver.checkpoints.captureCheckpoint")(function* (input) {
      ...
      const commitEnv: NodeJS.ProcessEnv = {
        ...
        GIT_AUTHOR_NAME: "Platon Code",
        GIT_AUTHOR_EMAIL: "platon-code@users.noreply.github.com",
        GIT_COMMITTER_NAME: "Platon Code",
        GIT_COMMITTER_EMAIL: "platon-code@users.noreply.github.com",
      };
      ...
      yield* Effect.gen(function* () {
        ...
        const message = `platon checkpoint ref=${input.checkpointRef}`;
