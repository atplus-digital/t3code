...
const CONNECTIONS_KEY = "platon-code.connections";
const AGENT_AWARENESS_DEVICE_ID_KEY = "platon-code.agent-awareness.device-id";
const AGENT_AWARENESS_REGISTRATION_KEY = "platon-code.agent-awareness.registration";
const RECENT_THREAD_SHORTCUTS_KEY = "platon-code.recent-thread-shortcuts";
...
>()("@platon/mobile/persistence/MobileStorage") {}
