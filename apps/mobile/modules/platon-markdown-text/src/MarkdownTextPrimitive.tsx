...
import PlatonMarkdownTextRunNativeComponent from "./PlatonMarkdownTextRunNativeComponent";
import PlatonMarkdownTextNativeComponent from "./PlatonMarkdownTextNativeComponent";
...
function MarkdownTextPrimitiveChild({ style, children, ...rest }: MarkdownTextPrimitiveProps) {
  ...
  const nativeChildren = React.Children.toArray(children).map((child) => {
    ...
    return (
      ...
      <PlatonMarkdownTextRunNativeComponent
  ...
  if (!isAncestor) {
    return (
      <TextAncestorContext.Provider value={contextValue}>
        <PlatonMarkdownTextNativeComponent
          {...textDefaults}
          {...rest}
