...
import { EnvironmentHttpCommonError, PRIMARY_LOCAL_ENVIRONMENT_ID } from "@platon/contracts";
import type { EnvironmentHttpCommonError as EnvironmentHttpCommonErrorType } from "@platon/contracts";
