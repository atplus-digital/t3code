...
import { RelayManagedEndpoint } from "@platon/contracts/relay";
...
export class RemoteDpopAccessToken extends Schema.Class<RemoteDpopAccessToken>(
  "@platon/client-runtime/authorization/RemoteDpopAccessToken",
)({
...
>()("@platon/client-runtime/authorization/tokenStore/RemoteDpopAccessTokenStore") {}
