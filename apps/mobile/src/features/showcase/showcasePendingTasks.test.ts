import type { EnvironmentProject } from "@platon/client-runtime/state/shell";
import { EnvironmentId, ProjectId, ProviderInstanceId } from "@platon/contracts";
...
const projects: ReadonlyArray<EnvironmentProject> = [
  {
    ...
    id: ProjectId.make("platon-code"),
    title: "Platon Code",
    workspaceRoot: "/workspace/platon-code",
