import { readConnectAuthorizeRequest } from "@platon/shared/connectAuth";
...
const TEST_ENV = {
  PLATON_CODE_CLERK_PUBLISHABLE_KEY: "pk_test_Y2xlcmsuZXhhbXBsZS50ZXN0JA==",
  PLATON_CODE_CLERK_CLI_OAUTH_CLIENT_ID: "oauth_client_test",
  PLATON_CODE_HOSTED_APP_URL: "https://hosted.example.test",
};
