import type { VcsStatusRemoteResult, VcsStatusResult } from "@platon/contracts";
...
describe("normalizeGitRemoteUrl", () => {
  it("canonicalizes equivalent GitHub remotes across protocol variants", () => {
    expect(normalizeGitRemoteUrl("git@github.com:AcmeCorp/DemoApp.git")).toBe(
      "github.com/acmecorp/demoapp",
    );
    expect(normalizeGitRemoteUrl("https://github.com/AcmeCorp/DemoApp.git")).toBe(
      "github.com/acmecorp/demoapp",
    );
    expect(normalizeGitRemoteUrl("ssh://git@github.com/AcmeCorp/DemoApp")).toBe(
      "github.com/acmecorp/demoapp",
    );
  });

  it("preserves nested group paths for providers like GitLab", () => {
    expect(normalizeGitRemoteUrl("git@gitlab.com:AcmeCorp/platform/DemoApp.git")).toBe(
      "gitlab.com/acmecorp/platform/demoapp",
    );
    expect(normalizeGitRemoteUrl("https://gitlab.com/AcmeCorp/platform/DemoApp.git")).toBe(
      "gitlab.com/acmecorp/platform/demoapp",
    );
  });
...
describe("parseGitHubRepositoryNameWithOwnerFromRemoteUrl", () => {
  it("extracts the owner and repository from common GitHub remote shapes", () => {
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("git@github.com:AcmeCorp/DemoApp.git"),
    ).toBe("AcmeCorp/DemoApp");
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("https://github.com/AcmeCorp/DemoApp.git"),
    ).toBe("AcmeCorp/DemoApp");
  });
});
