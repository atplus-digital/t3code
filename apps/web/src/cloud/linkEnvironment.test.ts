...
import { RelayWebClientId } from "@platon/contracts/relay";
...
beforeEach(() => {
  vi.clearAllMocks();
  vi.stubEnv("VITE_PLATON_CODE_RELAY_URL", "https://relay.example.test");
  ...
  it.effect("uses desktop bearer auth for primary cloud link state", () =>
    Effect.gen(function* () {
      ...
      vi.stubGlobal("window", {
        location: { origin: "platon-code://app" },
        desktopBridge: {
