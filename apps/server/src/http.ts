...
import { isDevProxiedPath } from "@platon/shared/devProxy";
import { decodeOtlpTraceRecords } from "@platon/shared/observability";
...
const DESKTOP_RENDERER_ORIGINS = ["platon-code://app", "platon-code-dev://app"];
...
export const browserApiCorsLayer = Layer.unwrap(
  Effect.gen(function* () {
    ...
    //
    // PLATON_CODE_DEV_ALLOWED_ORIGINS covers dev servers reached from a second
