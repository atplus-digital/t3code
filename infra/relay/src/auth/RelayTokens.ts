...
import { encodeOAuthScope, parseAllowedOAuthScope } from "@platon/shared/oauthScope";
import {
...
const ACCESS_TOKEN_TYP = "platon-relay-dpop-access+jwt";
...
>()("platon-code-relay/auth/RelayTokens") {}
