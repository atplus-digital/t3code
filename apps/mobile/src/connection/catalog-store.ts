...
import { ConnectionTransientError } from "@platon/client-runtime/connection";
...
export const CONNECTION_CATALOG_KEY = "platon-code.connection-catalog.v1";
export const LEGACY_CONNECTIONS_KEY = "platon-code.connections";
