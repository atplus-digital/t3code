import type { EnvironmentRpcSubscriptionObservation } from "@platon/client-runtime/rpc";
import { type BackgroundScope, type EnvironmentId, WS_METHODS } from "@platon/contracts";
