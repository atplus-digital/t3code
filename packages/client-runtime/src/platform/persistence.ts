...
>()("@platon/client-runtime/platform/persistence/ConnectionTargetStore") {}
...
>()("@platon/client-runtime/platform/persistence/ConnectionRegistrationStore") {}
...
>()("@platon/client-runtime/platform/persistence/EnvironmentCacheStore") {}
...
}>("@platon/client-runtime/platform/persistence/EnvironmentOwnedDataCleanup", {
  defaultValue: () => ({
    clear: () => Effect.void,
  }),
}) {}
