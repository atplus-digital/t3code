...
import { scopeThreadRef } from "@platon/client-runtime/environment";
import { EnvironmentProject } from "@platon/client-runtime/state/shell";
import { mapAtomCommandResult } from "@platon/client-runtime/state/runtime";
import {
  ThreadId,
  type ModelSelection,
