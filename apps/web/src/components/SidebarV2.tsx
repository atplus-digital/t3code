...
import type { EnvironmentThreadShell } from "@platon/client-runtime/state/models";
import {
  scopeProjectRef,
  scopeThreadRef,
  scopedThreadKey,
} from "@platon/client-runtime/environment";
import type { ScopedThreadRef, SidebarProjectGroupingMode } from "@platon/contracts";
import {
  AlarmClockIcon,
  AlarmClockOffIcon,
  CheckIcon,
