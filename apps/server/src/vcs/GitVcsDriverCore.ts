...
import { dedupeRemoteBranchesWithLocalMatches, normalizeGitRemoteUrl } from "@platon/shared/git";
import { compactTraceAttributes } from "@platon/shared/observability";
import { decodeJsonResult } from "@platon/shared/schemaJson";
...
> {
  ...
  const traceFilePath = yield* fs.makeTempFileScoped({
    prefix: `platon-code-git-trace2-${process.pid}-`,
    suffix: ".json",
  });
