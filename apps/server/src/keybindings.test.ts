import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@platon/contracts";
...
import { KeybindingsConfigError } from "@platon/contracts";
    ...
    Layer.provideMerge(
      Layer.fresh(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "platon-code-keybindings-test-",
        }),
      ),
    ),
  );
