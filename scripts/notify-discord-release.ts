  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Platon Code prerelease is available for nightly testers."
          : "A new Platon Code latest release is available.",
...
).pipe(Command.withDescription("Post a Platon Code release announcement to Discord."));
