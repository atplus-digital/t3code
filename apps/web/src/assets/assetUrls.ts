...
import { resolveAssetUrl } from "@platon/client-runtime/state/assets";
import type { AssetResource, EnvironmentId } from "@platon/contracts";
...
export { resolveAssetUrl } from "@platon/client-runtime/state/assets";
