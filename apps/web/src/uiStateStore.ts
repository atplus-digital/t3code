...
export const PERSISTED_STATE_KEY = "platon-code:ui-state:v1";
const THREAD_CHANGED_FILES_EXPANSION_VERSION = 1;
const LEGACY_PERSISTED_STATE_KEYS = [
  "platon-code:renderer-state:v8",
  "platon-code:renderer-state:v7",
  "platon-code:renderer-state:v6",
  "platon-code:renderer-state:v5",
  "platon-code:renderer-state:v4",
  "platon-code:renderer-state:v3",
