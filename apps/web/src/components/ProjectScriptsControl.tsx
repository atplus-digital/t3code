...
const NO_FILE_SCRIPTS: ReadonlyArray<PlatonProjectFileScript> = [];

interface ProjectScriptsControlProps {
  scripts: ReadonlyArray<ProjectScript>;
  /** Scripts declared in the project's checked-in platon.json, offered for import. */
  fileScripts?: ReadonlyArray<PlatonProjectFileScript>;
...
export default function ProjectScriptsControl({
  ...
  const importFileScript = async (fileScript: PlatonProjectFileScript) => {
  ...
  const importMenuItems = importableScripts.length > 0 && (
    <>
      ...
      <MenuGroup>
        <MenuGroupLabel>From platon.json</MenuGroupLabel>
