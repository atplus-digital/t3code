...
import { SourceControlProviderError, type ChangeRequest } from "@platon/contracts";
...
export const makeDiscovery = Effect.gen(function* () {
  ...
  return {
    ...
    label: "Bitbucket",
    installHint:
      "Set PLATON_CODE_BITBUCKET_EMAIL and PLATON_CODE_BITBUCKET_API_TOKEN on the server (use a Bitbucket API token with pull request and repository scopes).",
