...
import { HostProcessArguments } from "@platon/shared/hostProcess";
 ...
 * Detection is best-effort; callers must fail closed to a plain `platon` command.
 */
...
export function formatCliCommand(input: {
  ...
  if (runner === null) {
    return `platon ${input.subcommand}`;
  }
