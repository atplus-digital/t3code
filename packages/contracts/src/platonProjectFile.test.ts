...
import { PlatonProjectFile } from "./platonProjectFile.ts";

const decode = Schema.decodeUnknownSync(PlatonProjectFile);

describe("PlatonProjectFile", () => {
  it("decodes a full project file", () => {
    const decoded = decode({
      $schema: "https://t3.codes/schema/platon.json",
