import type { EnvironmentId, SidebarThreadSortOrder } from "@platon/contracts";
...
import { PlatonWordmark } from "../../components/PlatonWordmark";
        ...
        <View className="w-full max-w-[720px] self-center gap-3">
          <View className="flex-row items-center gap-2.5">
            <View className="flex-1 flex-row items-center gap-2">
              ...
              <PlatonWordmark color={iconColor} height={15} />
