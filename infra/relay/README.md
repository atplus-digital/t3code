# Platon Connect Relay

> [!NOTE]
> Sign in to Platon Connect from the app under Settings > Connections.

The relay is the hosted control plane for Platon Connect. It helps clients discover and connect to
...
- Linking Platon Code environments to a cloud account.
