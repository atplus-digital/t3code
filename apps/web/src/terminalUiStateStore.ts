...
import { parseScopedThreadKey, scopedThreadKey } from "@platon/client-runtime/environment";
import { type ScopedThreadRef } from "@platon/contracts";
...
const TERMINAL_UI_STATE_STORAGE_KEY = "platon-code:terminal-state:v1";
