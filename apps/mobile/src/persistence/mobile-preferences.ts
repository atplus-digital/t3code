...
const PREFERENCES_KEY = "platon-code.preferences";
const PREFERENCES_FALLBACK_KEY = "platon-code.preferences.fallback";
...
>()("@platon/mobile/persistence/MobilePreferencesStore") {}
