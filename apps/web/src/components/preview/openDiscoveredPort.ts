import type { DiscoveredLocalServer, ScopedThreadRef } from "@platon/contracts";
import { mapAtomCommandResult, type AtomCommandResult } from "@platon/client-runtime/state/runtime";
