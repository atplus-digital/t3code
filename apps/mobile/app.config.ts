...
const isIosPersonalTeamBuild = repoEnv.PLATON_CODE_IOS_PERSONAL_TEAM === "1";

const personalTeamBundleIdentifier = repoEnv.PLATON_CODE_IOS_PERSONAL_TEAM_BUNDLE_ID?.trim();
...
if (
  ...
  throw new Error(
    "PLATON_CODE_IOS_PERSONAL_TEAM_BUNDLE_ID must be a reverse-DNS identifier such as com.example.platon-code when PLATON_CODE_IOS_PERSONAL_TEAM=1.",
  );
}
...
const VARIANT_CONFIG = {
  development: {
    appName: "Platon Code Dev",
    scheme: "platon-code-dev",
    iosBundleIdentifier: "com.platon.platon-code.dev",
    androidPackage: "com.platon.platon-code.dev",
    relyingParty: "clerk.t3.codes",
    assets: DEVELOPMENT_ASSETS,
  },
  preview: {
    appName: "Platon Code Preview",
    scheme: "platon-code-preview",
    iosBundleIdentifier: "com.platon.platon-code.preview",
    androidPackage: "com.platon.platon-code.preview",
    relyingParty: "clerk.t3.codes",
  ...
  production: {
    appName: "Platon Code",
    scheme: "platon-code",
    iosBundleIdentifier: "com.platon.platon-code",
    androidPackage: "com.platon.platon-code",
    relyingParty: "clerk.t3.codes",
    ...
    widgets: [
      {
        ...
        description: "Shows the current state of active Platon Code agents.",
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    requireFullScreen: process.env.PLATON_SHOWCASE_CAPTURE_BUILD === "1",
    bundleIdentifier: iosBundleIdentifier,
    // Pin code signing to the Platon team so non-interactive `expo run:ios`
    ...
    infoPlist: {
      ...
      NSLocalNetworkUsageDescription:
        "Allow Platon Code to connect to Platon Code servers on your local network or tailnet.",
      ...
      ...(process.env.PLATON_SHOWCASE_CAPTURE_BUILD === "1"
        ? {
  ...
  plugins: [
    ...
    [
      ...
      {
        cameraPermission:
          "Allow Platon Code to access your camera so you can scan pairing QR codes.",
  ...
  extra: {
    ...
    relay: {
      url: repoEnv.PLATON_CODE_RELAY_URL ?? null,
    },
    clerk: {
