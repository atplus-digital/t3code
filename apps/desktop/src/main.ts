...
import { resolveRemotePlatonCliPackageSpec } from "@platon/ssh/command";
import type { RemotePlatonRunnerOptions } from "@platon/ssh/tunnel";
...
const resolveDesktopSshCliRunner = (
...
): RemotePlatonRunnerOptions => {
  const devRemoteEntryPath = Option.getOrUndefined(environment.devRemotePlatonServerEntryPath);
  ...
  return {
    packageSpec: resolveRemotePlatonCliPackageSpec({
