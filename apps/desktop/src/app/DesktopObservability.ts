import { PRIMARY_LOCAL_ENVIRONMENT_ID } from "@platon/contracts";
import { makeLocalFileTracer, makeTraceSink } from "@platon/shared/observability";
...
>()("@platon/desktop/app/DesktopObservability/DesktopBackendOutputLogFactory") {}
