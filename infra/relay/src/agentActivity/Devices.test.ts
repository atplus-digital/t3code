import type { RelayDeviceRegistrationRequest } from "@platon/contracts/relay";
...
const registration: RelayDeviceRegistrationRequest = {
  ...
  bundleId: "com.platon.platon-code.preview" as RelayDeviceRegistrationRequest["bundleId"],
