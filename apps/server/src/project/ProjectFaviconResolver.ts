...
>()("platon/project/ProjectFaviconResolver") {}
...
export const make = Effect.gen(function* () {
  ...
  const projectFileLoader = yield* PlatonProjectFileLoader.PlatonProjectFileLoader;
  ...
  const resolvePath: ProjectFaviconResolver["Service"]["resolvePath"] = Effect.fn(
    ...
    // A platon.json iconPath takes precedence over the well-known locations.
