import { CheckpointRef, EnvironmentId, MessageId, TurnId } from "@platon/contracts";
        ...
        timelineEntries={[
          {
            ...
            entry: {
              ...
              label: "Updated files",
              tone: "tool",
              changedFiles: ["C:/Users/mike/dev-stuff/platon-code/apps/web/src/session-logic.ts"],
            },
          },
        ]}
        workspaceRoot="C:/Users/mike/dev-stuff/platon-code"
      />,
    );

    expect(markup).toContain("platon-code/apps/web/src/session-logic.ts");
    expect(markup).not.toContain(
      "C:/Users/mike/dev-stuff/platon-code/apps/web/src/session-logic.ts",
    );
  });
