...
import { waitForHttpReady as waitForHttpReadyShared } from "@platon/shared/httpReadiness";
...
const BACKEND_READINESS_PATH = "/.well-known/platon/environment";
...
export interface DesktopBackendStartConfig extends BackendProcessContext {
  ...
  // PLATON_CODE_HOME can't pin the WSL backend to /mnt/c/...\.platon.
