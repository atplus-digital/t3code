...
import { isExplicitRelativePath, isWindowsAbsolutePath } from "@platon/shared/path";
import { normalizeSearchQuery } from "@platon/shared/searchRanking";
...
>()("platon/workspace/WorkspaceEntries") {}
