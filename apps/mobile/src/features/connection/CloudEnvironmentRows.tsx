...
interface CloudEnvironmentRowsProps {
  ...
  /**
   * Hide the "Platon Connect" section title + refresh button for hosts that
...
/**
 * "Platon Connect" section: every environment published to the signed-in account,
 * with connect switches, availability status, refresh, and loading/error
 * states. Shared between the Settings environments screen and the Platon Connect
 * onboarding sheet.
 */
