...
const rule = createOxlintRuleHarness("platon-code/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("platon-code/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("platon-code/no-manual-effect-runtime-in-tests");
