 ...
 */
import { IsoDateTime, ModelSelection, ProjectId, ProjectScript } from "@platon/contracts";
...
>()("platon/persistence/Services/ProjectionProjects/ProjectionProjectRepository") {}
