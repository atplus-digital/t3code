...
import { type CodexSettings, type ModelSelection } from "@platon/contracts";
...
import { getModelSelectionStringOptionValue } from "@platon/shared/model";
...
export const makeCodexTextGeneration = Effect.fn("makeCodexTextGeneration")(function* (
  ...
  const writeTempFile = (
    ...
    fileSystem
      .makeTempFileScoped({
        prefix: `platon-code-${prefix}-${process.pid}-`,
      })
      .pipe(
