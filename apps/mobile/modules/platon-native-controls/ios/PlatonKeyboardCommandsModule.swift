...
public final class PlatonKeyboardCommandsModule: Module {
  public func definition() -> ModuleDefinition {
    Name("PlatonKeyboardCommands")

    View(PlatonKeyboardCommandsView.self) {
      Prop("enabledCommands") { (view: PlatonKeyboardCommandsView, commands: [String]) in
...
public final class PlatonKeyboardCommandsView: ExpoView {
