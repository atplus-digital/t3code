...
>()("@platon/desktop/shell/DesktopShellEnvironment") {}
...
const startMarker = (name: string) => `__PLATON_CODE_ENV_${name}_START__`;
const endMarker = (name: string) => `__PLATON_CODE_ENV_${name}_END__`;
