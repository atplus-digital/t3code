import { type KnownTerminalSession } from "@platon/client-runtime/state/terminal";
import { DEFAULT_TERMINAL_ID, type ProjectScript } from "@platon/contracts";
...
} from "@platon/shared/terminalLabels";
