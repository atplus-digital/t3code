...
import { makeKeyedCoalescingWorker } from "@platon/shared/KeyedCoalescingWorker";
import { HostProcessPlatform } from "@platon/shared/hostProcess";
import { getTerminalLabel } from "@platon/shared/terminalLabels";
...
>()("platon/terminal/Manager/TerminalManager") {}
...
function shouldExcludeTerminalEnvKey(key: string): boolean {
  ...
  if (normalizedKey.startsWith("PLATON_CODE_")) {
    return true;
  }
