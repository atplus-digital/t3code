import type { DesktopSshEnvironmentTarget, EnvironmentId } from "@platon/contracts";
import { resolveRemotePairingTarget } from "@platon/shared/remote";
...
>()("@platon/client-runtime/connection/onboarding/ConnectionOnboarding") {}
