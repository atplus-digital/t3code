import { collectComposerInlineTokens } from "@platon/shared/composerInlineTokens";
...
import { markdownFileIconSource } from "@platon/mobile-markdown-text/file-icons";
import { resolveMarkdownFileIcon } from "@platon/mobile-markdown-text/links";
...
import type { ComposerEditorProps, ComposerEditorSelection } from "./PlatonComposerEditor.types";

const NATIVE_MODULE_NAME = "PlatonComposerEditor";
...
} from "./PlatonComposerEditor.types";
